...
public class Order implements Serializable{
	...
	@JsonFormat( shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd'T'HH:mm:dd'Z'", timezone = "GMT" )
	...
	@OneToOne( mappedBy = "order", cascade = CascadeType.ALL ) //Essa notação do cascade é usada quando a associação é 1 para 1	
